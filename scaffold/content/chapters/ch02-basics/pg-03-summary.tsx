  ...
  return (
    <>
      <Anim type="slide-left" delay={0} w={8} h={56} x={120} y={80}>
        <div style={{ width: '100%', height: '100%', background: '#F59E0B', borderRadius: 4 }} />
      </Anim>
          ...
          <Anim key={i} type="slide-left" delay={350 + i * 250} w={760} h={76} x={0} y={i * 88}>
            <Cardbox variant="default" x={0} y={0} w={760} h={76}>
              <SVG x={24} y={22} w={32} h={32} viewBox="0 0 32 32">
                <circle cx="16" cy="16" r="16" fill="#F59E0B" fillOpacity={0.15} />
                <circle cx="16" cy="16" r="10" fill="none" stroke="#F59E0B" strokeWidth={1.5} />
                <path d="M11 16l3 3 7-7" fill="none" stroke="#F59E0B" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
              </SVG>
