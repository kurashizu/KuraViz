    ...
    <>
      <Anim type="fade-in" delay={0} x={0} y={0} w={1920} h={1080}>
        <div style={{
          ...
          background: `radial-gradient(ellipse at 50% 35%, ${colors.brand.secondary}26, transparent 65%)`,
        }} />
      </Anim>

      <Anim type="fade-in" delay={200} x={cx - 100} y={320} w={200} h={48}>
        <Cardbox variant="bordered" x={0} y={0} w={200} h={48}>
          <Text variant="caption" x={0} y={7} w={190} style={{ textAlign: 'center' }}>Chapter 02</Text>
        </Cardbox>
      </Anim>
      ...
      <Anim type="slide-up" delay={400} x={cx - 500} y={420} w={1000} h={86}>
        <Text variant="h1" x={0} y={0} w={1000} style={{ textAlign: 'center' }}>Columns & Lists</Text>
      </Anim>
