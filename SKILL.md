...
├── video.mp4                 # ✏️ Generated by tools/capture.mjs
└── scaffold/
    ├── content/chapters/      # ✏️ Page components (create/edit here)
    ├── public/
    │   ├── narration.json     # ✏️ Narration scripts (edit here)
    │   └── audio/             # ❌ Generated by tools/generate_audio.py
    ├── components/            # 📖 Read only — component library
    ├── lib/                   # 📖 Read only — utilities, types
