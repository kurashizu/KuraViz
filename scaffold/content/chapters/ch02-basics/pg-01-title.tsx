...
export default function Pg01Title() {
  ...
  return (
    <>
      ...
      <Anim type="fade-in" delay={200} x={cx - 48} y={280} w={96} h={36}>
        <Cardbox variant="bordered" x={0} y={0} w={96} h={36}>
          <Text variant="caption" x={0} y={6} w={96} style={{ textAlign: 'center' }}>Ch02</Text>
        </Cardbox>
      </Anim>

      <Anim type="scale-in" delay={300} w={480} h={4} x={cx - 240} y={332}>
        <div style={{
          width: '100%', height: '100%',
      ...
      <Anim type="slide-up" delay={400} x={cx - 500} y={370} w={1000} h={110}>
        <Text variant="h1" x={0} y={0} w={1000} style={{ textAlign: 'center' }}>
          第二章 · 核心概念
        </Text>
      </Anim>

      <Anim type="fade-in" delay={700} x={cx - 350} y={530} w={700} h={65}>
